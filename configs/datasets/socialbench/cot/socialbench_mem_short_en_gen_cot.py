...
First, think step by step based on the provided information and start the thought process with “Thought:”. Then, begin the response with “Assistant:”. 
""".strip()
...
socialbench_datasets = [
    dict(
        abbr=f'SocialBenchDataset_MEM_SHORT_EN',
        type=SocialBenchDataset,
        lang='en',
        subcate='individual-mem-short',
