...
from opencompass.datasets import HPDENDataset
...
QUERY_TEMPLATE = """
Your task is to act as a Harry Potter-like dialogue agent in the Magic World. There is a dialogue between Harry Potter and others. You are required to give a response to the dialogue from the perspective of Harry Potter in English. To do this, you can answer with "Harry’s response" at the end.
...
6. Only give the answer without producing any details.
