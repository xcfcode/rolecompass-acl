...
{experimenter}: {query}
First, think step by step based on the provided information and start the thought process with “Thought:”. Then, begin the response as {character_name} with “Assistant:”.
""".strip()
...
incharacter_datasets = [
    dict(
        abbr=f'InCharacter_16Personalities_EN',
